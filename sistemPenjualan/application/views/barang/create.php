	...
	<div class="container-fluid">
		<div class="col-md-12">
			<div class="card">
				...
				<?= form_open(site_url('barang_controller/storeBarang'), ['method' => "POST"]) ?>
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" class="form-control" id="jumlah_barang" placeholder="Masukkan Jumlah Barang" name="jumlah_barang">
